...
El jar final se escribe en `build/libs/bm3-plasma-1.1.1.jar`. Los jars precompilados de las versiones etiquetadas se publican como GitHub Releases.

## Instalación

1. Copia `build/libs/bm3-plasma-1.1.1.jar` (o descarga el último jar desde la página de GitHub Releases) a la carpeta `mods/` de una instancia **Fabric 26.2** (requiere Fabric API). Usuarios de Legacy Launcher / vanilla: ponlo en `.minecraft/mods` y ejecuta un perfil **Fabric**.
